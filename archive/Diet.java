...
public class Diet {
    ...
    int solveDietProblem(int n, int m, double A[][], double[] b, double[] c, double[] x) {
        List constraints = new ArrayList(A.length);
        List<Double> rhs = new ArrayList<>(b.length);
        ...
        try {
            double[] result = new MySimplexSolver().solve(c, constraints, rhs);
    ...
    public static class MySimplexSolver {
